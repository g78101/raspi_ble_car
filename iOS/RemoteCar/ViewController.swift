...
//  RemoteCar
//
//  Created by Talka_Ying on 2017/8/16.
...
class ViewController: UIViewController, StreamManagerDelegate {
    ...
    //MARK: - Button Click
    func photoButtonClicked(_ sender:UIButton) {
    ...
    func LButtonDown(_ sender:UIButton) {
    ...
    func LButtonUp(_ sender:UIButton) {
        leftWheelStatus = .Stop
    }
    
    func RButtonDown(_ sender:UIButton) {
    ...
    func RButtonUp(_ sender:UIButton) {
        rightWheelStatus = .Stop
    }
    ...
    func recordButtonDown(_ sender:UIButton) {
    ...
    func recordButtonUp(_ sender:UIButton) {
        if #available(iOS 10.0, *), voiceEnable {
