...
//  RemoteCar
//
//  Created by Talka_Ying on 2017/8/17.
...
let YOUR_PI_BULETOOTH = "TalkaYing"
let SEND_TIME_INTERVAL = 0.2

class BluetoothManager : NSObject, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDataSource, UITableViewDelegate {
